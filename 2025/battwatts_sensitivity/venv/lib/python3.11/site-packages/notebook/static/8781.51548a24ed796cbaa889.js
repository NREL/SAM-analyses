...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5379);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(10866),
    __webpack_require__(56602),
    __webpack_require__(69360),
    __webpack_require__(77586),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(11337),
  __webpack_require__(53196),
  __webpack_require__(29333),
  __webpack_require__(51679),
  __webpack_require__(81280),
  __webpack_require__(60612),
  __webpack_require__(36087),
  
      (__webpack_require__(40831)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(11984)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(37807),
  __webpack_require__(79185),
  
      (__webpack_require__(98514)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(37030)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(26715),
  
      (__webpack_require__(44152)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(74597)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(19494)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(6950)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(45222)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(97500),
  __webpack_require__(42709),
  __webpack_require__(74304),
  __webpack_require__(19782),
  
      (__webpack_require__(46093)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(31053),
  __webpack_require__(14343),
  __webpack_require__(53063),
  
      (__webpack_require__(32346)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(23112),
  __webpack_require__(58117),
  __webpack_require__(41179),
  __webpack_require__(27573),
  __webpack_require__(43617),
  __webpack_require__(43412),
  __webpack_require__(17743),
  __webpack_require__(10121),
  __webpack_require__(37953),
  __webpack_require__(22924),
  ...
  switch (page) {
    ...
    case '/tree': {
      baseMods = baseMods.concat([
        __webpack_require__(13419),
  __webpack_require__(14355),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(29350),
  
      (__webpack_require__(21047)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(57146),
  ...
  __webpack_require__(13419),
      ...
      (__webpack_require__(74507)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(51024)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(23578)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(94696).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(57633).IServiceManager);
...
//# sourceMappingURL=8781.51548a24ed796cbaa889.js.map?v=51548a24ed796cbaa889